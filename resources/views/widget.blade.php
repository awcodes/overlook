<x-filament-widgets::widget id="overlook-widget" @class(['hidden' => ! $data])>
    ...
    >
        @foreach ($data as $resource)
            <x-overlook::column>
                <x-filament::section
                    class="overlook-card rounded-xl overflow-hidden relative h-24 bg-linear-to-tr from-gray-100 via-white to-white dark:from-gray-950 dark:via-gray-900 dark:to-gray-900"
                >
                    <a
                        href="{{ $resource['url'] }}"
